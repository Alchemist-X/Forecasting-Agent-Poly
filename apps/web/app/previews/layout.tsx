...
const previewItems = [
  ...
  { href: "/previews/primary-ledger-folio", label: "Primary A · Folio" },
  { href: "/previews/primary-ledger-terminal", label: "Primary B · Terminal" },
  { href: "/previews/primary-ledger-exchange", label: "Primary C · Exchange" }
];
