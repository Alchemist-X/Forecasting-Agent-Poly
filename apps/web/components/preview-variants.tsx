...
const previewRoutes = [
  ...
  {
    href: "/previews/primary-ledger-folio",
    name: "Primary A",
    title: "Folio",
    summary: "沿用 Primary 实盘数据和原 ledger 信息结构，但改成偏研究简报的纸面卡片风格。"
  },
  {
    href: "/previews/primary-ledger-terminal",
    name: "Primary B",
    title: "Terminal",
    summary: "沿用同一组 Primary 交易数据，改成高密度 operator terminal 风格，适合频繁扫盘。"
  },
  {
    href: "/previews/primary-ledger-exchange",
    name: "Primary C",
    title: "Exchange",
    summary: "沿用同一组 Primary 交易数据，改成清爽券商看板风格，强调 NAV、ROI 和 ledger 可读性。"
  }
] as const;
