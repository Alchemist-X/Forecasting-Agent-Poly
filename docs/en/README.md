...
flowchart TD
  ...
  sources --> evidenceGraph["Evidence Graph<br/>source, time, stance, confidence, conflicts"]
  evidenceGraph --> model["Probability Model<br/>conditional decomposition and Bayesian updates"]
